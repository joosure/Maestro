defmodule SymphonyElixir.Workflow.StructuredExecutionPlan.RequirementAnalysisProfileTemplateTest do
  use ExUnit.Case, async: true

  alias SymphonyElixir.Workflow.StructuredExecutionPlan
  alias SymphonyElixir.Workflow.StructuredExecutionPlan.ProfileTemplates.RequirementAnalysis
