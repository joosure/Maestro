defmodule SymphonyElixir.Workflow.Profiles.RequirementAnalysis.StructuredExecutionPlan do
  @moduledoc """
  Profile-owned structured execution plan adoption template for `requirement_analysis.v1`.
  ...
  @default_status Contract.active_plan_status()
  @template_statuses [AgentContract.draft_plan_status(), Contract.active_plan_status()]
  @allowed_completion_routes ~w(needs_info review ready rejected)
  @agent_owned_item_kinds [AgentContract.agent_step_item_kind()]

  @item_specs [
    %{
      "item_id" => "analysis.ambiguities",
      "title" => "Record ambiguity list",
      "kind" => AgentContract.agent_step_item_kind(),
      "required" => true,
      "criticality" => Contract.profile_required_criticality(),
      "owned_by" => AgentContract.agent_owner(),
      "depends_on" => [],
      "evidence_requirements" => [
        %{
          "evidence_kind" => "requirement_analysis.ambiguities_recorded",
          "required_fields" => ["ambiguities"],
          "trust_classes" => [AgentContract.agent_declared_trust_class()]
        }
      ],
      "extensions" => %{
    ...
    %{
      ...
      "kind" => AgentContract.agent_step_item_kind(),
      "required" => false,
      "criticality" => Contract.informational_criticality(),
      "owned_by" => AgentContract.agent_owner(),
    ...
    %{
      ...
      "kind" => Contract.handoff_record_item_kind(),
      "required" => true,
      "criticality" => Contract.profile_required_criticality(),
      "owned_by" => AgentContract.backend_owner(),
      "depends_on" => ["analysis.ambiguities", "analysis.assumptions", "analysis.questions"],
      "evidence_requirements" => [
        %{
          "evidence_kind" => "tracker_upsert_workpad",
          "required_fields" => ["tracker_kind", "workpad_id"],
          "trust_classes" => [AgentContract.tool_generated_trust_class()]
        }
      ],
      "extensions" => %{
        "symphony.requirement_analysis" => %{
    ...
    %{
      ...
      "kind" => Contract.state_transition_item_kind(),
      "required" => true,
      "criticality" => Contract.profile_required_criticality(),
      "owned_by" => AgentContract.backend_owner(),
      "depends_on" => [
