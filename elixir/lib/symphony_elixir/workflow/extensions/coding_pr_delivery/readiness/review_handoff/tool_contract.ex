defmodule SymphonyElixir.Workflow.Extensions.CodingPrDelivery.Readiness.ReviewHandoff.ToolContract do
  @moduledoc """
  ...
  @linear_attach_external_reference_tool "linear_attach_external_reference"
  @tapd_attach_external_reference_tool "tapd_attach_external_reference"
  ...
  @evidence_kind_by_tool %{
    ...
    @linear_attach_external_reference_tool => :tracker_change_proposal,
    @tapd_attach_external_reference_tool => :tracker_change_proposal,
    @repo_commit_tool => :repo_commit,
    @repo_push_tool => :repo_push,
