defmodule SymphonyElixir.Workflow.Extensions.CodingPrDelivery.Readiness.EvidenceContract do
  @moduledoc """
  Evidence bucket and field keys owned by Coding PR Delivery review handoff.

  Platform transition readiness owns the envelope and dispatch mechanics; this
  module owns the profile-specific observation vocabulary consumed by
  `coding_pr_delivery.review_handoff.v1`.
  """
  ...
  @workpad_evidence_kind @workpad_key
  @tracker_change_proposal_evidence_kind "tracker_change_proposal"
  ...
  @spec evidence_kind_key() :: String.t()
  def evidence_kind_key, do: @evidence_kind_key

  @spec workpad_evidence_kind() :: String.t()
  def workpad_evidence_kind, do: @workpad_evidence_kind

  @spec tracker_change_proposal_evidence_kind() :: String.t()
  def tracker_change_proposal_evidence_kind, do: @tracker_change_proposal_evidence_kind
