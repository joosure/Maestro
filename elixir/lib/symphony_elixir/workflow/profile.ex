defmodule SymphonyElixir.Workflow.Profile do
  ...
  A profile owns business route vocabulary, route policy defaults, and route
  lifecycle semantics. Trackers and workflow config own raw tracker states.
  """
  ...
  @callback options_schema() :: SymphonyElixir.Workflow.Profile.Options.schema()
