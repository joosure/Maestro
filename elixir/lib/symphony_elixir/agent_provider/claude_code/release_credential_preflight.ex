defmodule SymphonyElixir.AgentProvider.ClaudeCode.ReleaseCredentialPreflight do
  @moduledoc false

  @behaviour SymphonyElixir.AgentProvider.ReleaseCredentialPreflight

  alias SymphonyElixir.AgentProvider.ClaudeCode.CredentialEnv
  alias SymphonyElixir.AgentProvider.Kinds
  alias SymphonyElixir.AgentProvider.ReleaseCredentialPreflight

  @provider_kind Kinds.claude_code()
  @token_env_config "SYMPHONY_CLAUDE_CODE_TOKEN_ENV"
  @default_token_env CredentialEnv.oauth_token_env()
  @verify_command_env "SYMPHONY_CLAUDE_CODE_VERIFY_COMMAND"
