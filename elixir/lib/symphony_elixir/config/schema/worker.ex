defmodule SymphonyElixir.Config.Schema.Worker do
  ...
  embedded_schema do
    ...
    field(:max_concurrent_local_agents, :integer)
  ...
  def changeset(schema, attrs) do
    schema
    |> cast(attrs, [:ssh_hosts, :max_concurrent_local_agents, :max_concurrent_agents_per_host], empty_values: [])
    |> normalize_ssh_hosts(attrs)
    |> validate_number(:max_concurrent_local_agents, greater_than: 0)
