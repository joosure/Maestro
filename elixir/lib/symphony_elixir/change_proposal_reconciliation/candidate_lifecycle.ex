defmodule SymphonyElixir.ChangeProposalReconciliation.CandidateLifecycle do
  @moduledoc """
  ...
  def new(opts \\ []) when is_list(opts) do
    %__MODULE__{
      max_defer_count: positive_integer(Keyword.get(opts, :max_defer_count), @default_max_defer_count),
      max_defer_age_ms: positive_integer(Keyword.get(opts, :max_defer_age_ms), @default_max_defer_age_ms)
    }
  end
