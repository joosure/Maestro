...
| `tracker/` | provider-neutral tracker internals | config access, registry, normalized errors, serialization, project refs, memory adapter | tracker-vendor transport details, repo-provider behavior | `Config`, `ConfigAccess`, `Registry`, `Error`, `ProjectRef` |
