Use this lifecycle for TAPD workflows where `review` remains a non-dispatch
wait route, `merging` remains a dispatchable merge route, and a human owns the
review-to-merge tracker transition.
