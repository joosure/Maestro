...
> If you see unfamiliar placeholders or need to check which tools are connected, inspect the current Codex session context and available tools instead of relying on a repo-local connectors file.
